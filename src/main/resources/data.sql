...
VALUES ('727e2463-f682-4389-97d2-f7e852feafce','create h2 database', 'please add 3 tables', 5, 'Completed', 4),
       ...
       ('4ec90405-4ad6-404f-86da-b5e1077ece1e','create JPA rep.', 'use JPA Interfaces', 5, 'New', 2),
       ('03b0aa47-1c81-4dd1-8e87-5ed468cfabfa','create Junit test', 'use Junit4', 5, 'New', 2),
       ('9f39cb2d-14df-4677-bc90-87d99bfc96af','create calc. service1', 'Please provide a GET plan endiont', 5, 'New', 2),
       ('2d800ebc-c402-43a9-b984-fd209219570f','create calc. service2', 'Please provide a planning algorithm', 5, 'New', 4),
